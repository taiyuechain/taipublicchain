...
//
// The taipublicchain library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the taipublicchain library. If not, see <http://www.gnu.org/licenses/>.
...
import (
	...
	"github.com/taiyuechain/taipublicchain/utils"
	"math/big"
	"sync"
	"time"
	...
	"github.com/taiyuechain/taipublicchain/crypto/ecies"
...
func NewPbftAgent(tai Backend, config *params.ChainConfig, engine consensus.Engine, election *elect.Election, gasFloor, gasCeil uint64) *PbftAgent {
	agent := &PbftAgent{
		config:               config,
		engine:               engine,
		eth:                  tai,
		fastChain:            tai.BlockChain(),
		snailChain:           tai.SnailBlockChain(),
