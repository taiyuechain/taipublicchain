...
// `tai_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/taichain/wiki/wiki/JSON-RPC#tai_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with tai_getFilterChanges.
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_newblockfilter
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_newfilter
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_getlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_uninstallfilter
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_getfilterlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#tai_getfilterchanges
