...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "taipublic.ipc", false, filepath.Join(os.TempDir(), "taipublic.ipc")},
		{"data", "taipublic.ipc", false, "data/taipublic.ipc"},
		{"data", "./taipublic.ipc", false, "./taipublic.ipc"},
		{"data", "/taipublic.ipc", false, "/taipublic.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "taipublic.ipc", true, `\\.\pipe\taipublic.ipc`},
		{"data", "taipublic.ipc", true, `\\.\pipe\taipublic.ipc`},
		{"data", `\\.\pipe\taipublic.ipc`, true, `\\.\pipe\taipublic.ipc`},
	}
