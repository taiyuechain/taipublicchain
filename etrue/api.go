...
// PublicTruechainAPI provides an API to access Taichain full node-related
// information.
type PublicTruechainAPI struct {
	e *Taichain
}

// NewPublicTruechainAPI creates a new Taichain protocol API for full nodes.
func NewPublicTruechainAPI(e *Taichain) *PublicTruechainAPI {
...
// ChainId retuurn current taichain's chain config.
...
func NewPublicMinerAPI(e *Taichain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Taichain) *PrivateMinerAPI {
...
func NewPrivateAdminAPI(etrue *Taichain) *PrivateAdminAPI {
...
func NewPublicDebugAPI(etrue *Taichain) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Taichain full node APIs exposed over
...
func NewPrivateDebugAPI(config *params.ChainConfig, etrue *Taichain) *PrivateDebugAPI {
