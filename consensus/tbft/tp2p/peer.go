...
import (
	"errors"
	"fmt"
	"github.com/taiyuechain/taipublicchain/consensus/tbft/metrics"
	"net"
	"sync/atomic"
	"time"

	"github.com/taiyuechain/taipublicchain/consensus/tbft/crypto"
	"github.com/taiyuechain/taipublicchain/consensus/tbft/help"
	tmconn "github.com/taiyuechain/taipublicchain/consensus/tbft/tp2p/conn"
...
// HandshakeTimeout performs the taichain P2P handshake between a given node
