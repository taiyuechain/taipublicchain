...
// `etai_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/taichain/wiki/wiki/JSON-RPC#etai_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with etai_getFilterChanges.
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(taichain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
type FilterCriteria taichain.FilterQuery
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(taichain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_getlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_uninstallfilter
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_getfilterlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#etai_getfilterchanges
