...
// Package etaiclient provides a client for the Ethereum RPC API.
package taiclient
...
func (ec *Client) TransactionByHash(ctx context.Context, hash Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, taichain.NotFound
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (taichain.Subscription, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q taichain.FilterQuery, ch chan<- types.Log) (taichain.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q taichain.FilterQuery) interface{} {
