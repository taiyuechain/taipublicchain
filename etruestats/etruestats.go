...
// Service implements an Taichain netstats reporting daemon that pushes local
...
func New(url string, ethServ *etrue.Taichain, lesServ *les.LightEtrue) (*Service, error) {
