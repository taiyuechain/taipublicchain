...
// PublicTaichainAPI provides an API to access Taichain full node-related
// information.
type PublicTaichainAPI struct {
	e *Taichain
}

// NewPublicTaichainAPI creates a new Taichain protocol API for full nodes.
func NewPublicTaichainAPI(e *Taichain) *PublicTaichainAPI {
