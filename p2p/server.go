...
import (
	...
	"github.com/taiyuechain/taipublicchain/p2p/enr"
	...
	"github.com/taiyuechain/taipublicchain/p2p/discover"
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "etai p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Taichain Node Record
