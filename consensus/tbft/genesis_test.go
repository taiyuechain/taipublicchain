...
func TestOutGenesisJson(t *testing.T) {
	...
	b, _ := ioutil.ReadFile("E:\\truechain\\src\\github.com\\truechain\\taipublicchain\\cmd\\taipublic\\genesis.json")
	...
	for i := 1; i <= 52; i++ {
		...
		e := ioutil.WriteFile("E:\\truechain\\src\\github.com\\truechain\\taipublicchain\\cmd\\taipublic\\"+fmt.Sprintf("genesis_%s.json", strconv.Itoa(i)), bytes, os.ModePerm)
		if e != nil {
